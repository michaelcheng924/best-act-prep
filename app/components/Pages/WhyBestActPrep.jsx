        ...
        return (
            <div className="page">
                <div className="why__beta-explanation">
                    <p>Get lifetime access to the Best ACT Prep online course while we continue building it! The price will go up as we add more to the course. For now, it's basically free, so sign up while you can! Ask for a refund anytime. Easy.</p>
                    <p><strong>Note:</strong> While we continue building the course, you may notice problems and crazy things happening. That's why it's only $3 for everything right now :). Feel free to contact us any time for help. <a href="mailto:support@bestactprep.co">support@bestactprep.co.</a></p>
                </div>
